...
export function BoardDetailsHeader({ board }) {
    ...
    return (
        <div className="board-details-header">
            ...
            <div className="board-users-data">
            ...
            <div className="views">
                ...
                <div className={`main-table view ${location.pathname.includes('/board') && 'active'}`}>
                ...
                <div className={`kanban view ${location.pathname.includes('/kanban') && 'active'}`}>
                    <div
