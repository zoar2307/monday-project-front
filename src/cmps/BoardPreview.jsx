                ...
                <article className="project-card flex flex-column">
                    ...
                    <span className="name-card">
                        ...
                        <div className="star-icon" onClick={handleClick}>
                            <svg
                                viewBox="0 0 20 20"
                                fill={isStarred ? 'rgb(255, 203, 0)' : 'rgb(103, 104, 121)'} // Fill yellow if clicked, otherwise no fill
                                width="20"
                                height="20"
                                aria-hidden="true"
                            ...
                            >
                                <path
                                    ...
                                    fill="isStarred"
                                    fillRule={isStarred ? 'rgb(255, 203, 0)' : 'evenodd'}
                                    clipRule={isStarred ? 'rgb(255, 203, 0)' : 'evenodd'}
                                ></path>
                            </svg>
                        </div>
                    </span>
